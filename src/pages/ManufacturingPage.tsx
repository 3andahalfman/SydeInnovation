        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white">
              <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Manufacturing</span>
            </h1>
          </div>
          <p className="text-xl text-gray-300 max-w-3xl leading-relaxed">
            End-to-end manufacturing support from prototyping to production-ready designs.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                We bridge the gap between design and production. Our manufacturing support 
                services ensure your designs are optimized for the intended manufacturing 
                process—whether it's 3D printing, CNC machining, or injection molding.
              </p>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                From rapid prototyping to production file preparation, we handle the technical 
                details so your parts come out right the first time. Our DFM analysis helps 
      ...
      <section className="py-20 bg-gradient-to-r from-blue-950 to-blue-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Let us prepare your designs for production
          </p>
